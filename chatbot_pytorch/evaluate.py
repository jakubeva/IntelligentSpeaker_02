...
from chatbot_pytorch.model import *
from chatbot_pytorch.train import indexesFromSentence
...
def chat(r):
    ...
    try:
        if beam_size == 1:
            ...
            r = ' '.join(output_words).replace("<EOS>", "").replace(" ", "")
            return r
...
if __name__ == '__main__':
    modelFile = './save/model/corpus/2-2_800/50000_checkpoint.tar'
    n_layers, hidden_size, reverse = parseFilename(modelFile)
