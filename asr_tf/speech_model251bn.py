...
class ModelSpeech():  # 语音模型类
    ...
    def CreateModel(self):
        ...
        #                   kernel_initializer='he_normal')(input_data)  # 卷积层1600,200,32
        ...
        # layer_h18 = Dense(self.MS_OUTPUT_SIZE, use_bias=True, kernel_initializer='he_normal')(layer_h17)  # 全连接层200,3200,1428
        #
