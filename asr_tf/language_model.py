...
class ModelLanguage():  # 语音模型类
    ...
    def LoadModel(self):
        self.dict_pinyin = self.GetSymbolDict('../asr_tf/dict.txt')
...
if (__name__ == '__main__'):
    ...
    # str_pinyin = ['da4', 'jia1', 'hao3', 'wo3', 'lai2', 'zi4', 'zhong1', 'guo2']
    # str_pinyin = ['lv4', 'shi4', 'yang2', 'chun1', 'yan1', 'jing3', 'da4', 'kuai4', 'wen2', 'zhang1', 'de', 'di3', 'se4', 'si4', 'yue4', 'de', 'lin2', 'luan2', 'geng4', 'shi4', 'lv4', 'de2', 'xian1', 'huo2', 'xiu4', 'mei4', 'shi1', 'yi4', 'ang4', 'ran2']
    # str_pinyin = ['chuang2', 'qian2', 'ming2', 'yue4', 'guang1', 'yi2', 'shi4', 'di4', 'shang4', 'shuang1']
    str_pinyin = ['dui4', 'bu4', 'qi3', 'xiong1', 'di4', 'men5', 'le5']
