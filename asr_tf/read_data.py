...
class DataSpeech():
    ...
    def LoadDataList(self):
        ...
        if self.type == 'train':
            ...
            filename_wavlist_stcmds = 'st-cmds' + self.slash + 'train.wav.txt'  # 音频地址
            filename_symbollist_thchs30 = 'thchs30' + self.slash + 'train.syllable.txt'
            filename_symbollist_stcmds = 'st-cmds' + self.slash + 'train.syllable.txt'  # 标注
        elif self.type == 'dev':
    ...
    def data_genetator(self, batch_size=32, audio_length=1600):
        ...
        while True:
            ...
            for i in range(batch_size):
                ...
                data_input, data_labels = self.GetData(ran_num)  # 通过随机数取一个数据,data_input形式类似1600，200，1，data_labels为一句话的拼音标注
                ...
                # 计算输入数据的长度并将其添加到input_length列表中
